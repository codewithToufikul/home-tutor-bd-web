...
export default function GuardianDashboard() {
  ...
  useEffect(() => {
    if (!profile.isUpdated) {
      const interval = setInterval(() => {
        setAlertMsg('⚠️ Please update your guardian profile and upload a picture to complete verification!');
        setShowAlert(true);
  ...
  const handleProfileSave = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      triggerToast('✅ Guardian profile and picture updated successfully! Notification removed.');
    }, 1000);
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/60 backdrop-blur-xl p-8 rounded-[32px] border border-white/40 shadow-xl shadow-ink/5 space-y-6 mt-8">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-display font-black text-ink">Update Guardian Profile & Image</h3>
                {!profile.isUpdated && (
