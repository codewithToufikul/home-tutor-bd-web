  ...
  useEffect(() => {
    const loadStatsAndRequests = async () => {
      ...
      try {
        ...
        const saved = await SavedTutorsService.listForGuardian(user.uid);
        const notices = await NoticeService.list();
        const guardianNotices = (notices || []).filter((n: any) => !n.audience || n.audience === 'Guardians' || n.audience === 'All');
        ...
        // build myRequests with applicants
